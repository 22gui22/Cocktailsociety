...
<div id="killscreen" class="end" style="display:none;">
	...
	<center><input class="form-control input-lg" style="width:40%" id="username" type="text" placeholder="Username"></center><br>
...
function post() { 
	var mon = money;
	$.post('validate.php',{postmoney:mon},function(data){ $('#dataquit').html(data); });
}
</script>
