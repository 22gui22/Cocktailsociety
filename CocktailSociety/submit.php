...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="namecocktail" name="namecocktail" required>
	</div>
	<div class="form-group">
    <label for="receita">Receita do cocktail:</label>
    <textarea class="form-control" id="reccocktail" name="reccocktail" rows="3" required></textarea>
    </div>
	<div class="form-group">
